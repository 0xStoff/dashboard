...
const Transactions = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        const [fiatPayments, fiatOrders, krakenLedgers] = await Promise.all([fetchBinanceFiatPayments(),
  ...
  const paginatedBinanceTransactions = transactions.slice(binancePage * binanceRowsPerPage,
    binancePage * binanceRowsPerPage + binanceRowsPerPage);

  const paginatedGnosisTransactions = gnosisTransactions.slice(gnosisPage * gnosisRowsPerPage,
    gnosisPage * gnosisRowsPerPage + gnosisRowsPerPage);
